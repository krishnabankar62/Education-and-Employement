...
public class RateNReview extends HttpServlet {
...
"                               <li class=\"nav-item\">\n" +
"                                   <img style=\"border-radius: 50%;\" src=\"images/ShareSEK1.png\" width=\"35%\" height=\"75%\">\n" +
"                               </li>"+
...
"	  </nav>"
                    + "");
            pw.println("<br><br><h1><b>To Review and Rate Please Login First...</b></h1>");pw.println("<b><a style=\"margin:90%\" href=Login> LogIn</a></b><br><br>");
            ...
            try{
                ...
                PreparedStatement st2 = con.prepareStatement("select ttext, uid, stdate,star from blog order by sno desc;");
