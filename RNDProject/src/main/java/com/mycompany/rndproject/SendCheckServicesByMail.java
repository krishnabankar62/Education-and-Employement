...
public class SendCheckServicesByMail extends HttpServlet {
...
"\n" 
 + "");
    ...
    //====================================================================================================================
        ...
        String msg = "Hello sir ! \n My name is : "+userName+"\n"+"I lives in : "+userLocation+"\n"+" , "+userSubDomain+"\n"+"I am a Student of : "+userQualification+"\n"+
                "Gender : "+userSex+"\n"+"I want Tution Classes for : "+userSkill+"\n"+"On : "+userTypeOfService+"\n"+"At : "+userTypeOfPlatform+"\n"+
                "\n\n Dear expert if you are available then let us know We will inform to Student \n Thank you !";
        
        try{
            Mailer.send("krishnabankar62@gmail.com","7566727426",email,"RND USER",msg);  
        }catch(Exception e)
        {
